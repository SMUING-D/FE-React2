const FOOTER_INFOS = [{ text: 'dydals3440@gmail.com' }, { text: '서울특별시 종로구 홍지문2길 20 상명대학교' }]

const SOCIAL_INFOS = [
  { url: 'https://open.kakao.com/o/s0svOsWf' },
  { url: 'https://www.instagram.com/smu_makeus_challenge/' },
]
